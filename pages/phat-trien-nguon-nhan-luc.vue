...
function apply_class_exclusion(e)
{
	...
	*/
			...
			<link rel="alternate" href="https://www.centralcons.vn/phat-trien-nguon-nhan-luc/" hreflang="vi" />
			<link rel="alternate" href="https://www.centralcons.vn/en/career-development/" hreflang="en" />
			<link rel="alternate"
				href="https://www.centralcons.vn/ch/%e4%ba%ba%e5%8a%9b%e8%b5%84%e6%ba%90%e5%bc%80%e5%8f%91/"
				hreflang="zh" />

			<!-- This site is optimized with the Yoast SEO plugin v22.1 - https://yoast.com/wordpress/plugins/seo/ -->
			<title>Phát triển nguồn nhân lực - CENTRAL</title>
			<link rel="canonical" href="https://www.centralcons.vn/phat-trien-nguon-nhan-luc/" />
			<meta property="og:locale" content="vi_VN" />
			<meta property="og:locale:alternate" content="en_US" />
			<meta property="og:locale:alternate" content="zh_CN" />
			<meta property="og:type" content="article" />
			<meta property="og:title" content="Phát triển nguồn nhân lực - CENTRAL" />
			<meta property="og:url" content="https://www.centralcons.vn/phat-trien-nguon-nhan-luc/" />
			...
			<script type="application/ld+json"
				class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"https://www.centralcons.vn/phat-trien-nguon-nhan-luc/","url":"https://www.centralcons.vn/phat-trien-nguon-nhan-luc/","name":"Phát triển nguồn nhân lực - CENTRAL","isPartOf":{"@id":"https://www.centralcons.vn/#website"},"datePublished":"2021-11-21T14:03:18+00:00","dateModified":"2021-12-06T06:53:50+00:00","breadcrumb":{"@id":"https://www.centralcons.vn/phat-trien-nguon-nhan-luc/#breadcrumb"},"inLanguage":"vi","potentialAction":[{"@type":"ReadAction","target":["https://www.centralcons.vn/phat-trien-nguon-nhan-luc/"]}]},{"@type":"BreadcrumbList","@id":"https://www.centralcons.vn/phat-trien-nguon-nhan-luc/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.centralcons.vn/"},{"@type":"ListItem","position":2,"name":"Phát triển nguồn nhân lực"}]},{"@type":"WebSite","@id":"https://www.centralcons.vn/#website","url":"https://www.centralcons.vn/","name":"CENTRAL","description":"","potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.centralcons.vn/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"vi"}]}</script>
			<!-- / Yoast SEO plugin. -->
			...
			<link rel="alternate" title="JSON" type="application/json"
				href="https://www.centralcons.vn/wp-json/wp/v2/pages/386" />
			<link rel="EditURI" type="application/rsd+xml" title="RSD"
				href="https://www.centralcons.vn/xmlrpc.php?rsd" />
			<meta name="generator" content="WordPress 6.7.2" />
			<link rel='shortlink' href='https://www.centralcons.vn/?p=386' />
			<link rel="alternate" title="oNhúng (JSON)" type="application/json+oembed"
				href="https://www.centralcons.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.centralcons.vn%2Fphat-trien-nguon-nhan-luc%2F" />
			<link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"
				href="https://www.centralcons.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.centralcons.vn%2Fphat-trien-nguon-nhan-luc%2F&#038;format=xml" />
  ...
  gtag('config', 'UA-140682733-1');
		...
		<body
			class="page-template page-template-careers page-template-page-career-development page-template-careerspage-career-development-php page page-id-386 mega-menu-menu-1 unselectable">
			<!--[if lt IE 8]>
...
<![endif]-->
			...
			<div class="wrapper_content">
				<div class="page_cover">
					...
					<div class="meta_info">
						...
						<div class="breadcrumb_site"><span><span><a href="https://www.centralcons.vn/">Home</a></span> »
								<span class="breadcrumb_last" aria-current="page">Phát triển nguồn nhân
									lực</span></span></div>
					</div>
					<div class="stripe">
						<div class="container">
				...
				<div class="menu_careers">
					<div class="container">
						<ul id="menu-menu-careers" class="">
							...
							<li id="menu-item-389"
								class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-386 current_page_item menu-item-389">
								<a href="https://www.centralcons.vn/phat-trien-nguon-nhan-luc/" aria-current="page">Phát
				...
				<div class="careers_page pt-5">
					<div class="container">
						<h1 class="fs-40 fw-bold">Phát triển nguồn nhân lực</h1>
						<hr>
						<div class="mep_contractor mt-5">
							<div class="row gx-md-5 align-items-center justify-content-center">
								<div class="col-md-4 col-8 order-md-1">
									<div class="img_mep mb-3">
										<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/dev1.png"
											class="img-fluid" alt="">
									</div>
								</div>
								<div class="col-md-4 order-md-0">
									<h3 class="fs-30 cl-orange fw-bold mb-4">Công tác đào tạo <br />
										Phát triển nguồn nhân lực</h3>
									<div class="text-justify">
										Chúng tôi sử dụng nguồn lực & phải biết chắc chắn rằng công việc và con người
										phải phù hợp, từ đó thúc đẩy sự phát triển tốt nhất của mỗi cá nhân. Vì vậy, đào
										tạo nội bộ là quy trình bắt buộc không chỉ dành riêng cho các nhân sự mới. Trong
										quá trình làm việc, tất cả các nhân viên đều có cơ hội bồi dưỡng kiến thức
										chuyên môn với các chuyên gia được mời đến tận nơi hoặc được tài trợ học bổng
										toàn phần cho các khóa học khác. </div>
								</div>
								<div class="col-md-4 order-md-2">
									<h3 class="fs-40 d-none d-md-block cl-orange fw-bold mb-4">&nbsp;</h3>
									<div class="text-justify mb-3">
										Phát triển nguồn nhân lực là điều kiện quyết định để doanh nghiệp có thể tồn tại
										và phát triển trong nền kinh tế thị trường như hiện nay. Phát triển nguồn nhân
										lực giúp người lao động tự tin, tạo cho họ cảm giác yên tâm làm việc, gắn bó với
										Công ty, đem hết khả năng của mình phục vụ cho tổ chức, coi sự phát triển lớn
										mạnh của Công ty là sự phát triển của bản thân mỗi người. </div>
									<a href="" class="read_more">Tham gia với chúng tôi</a>
								</div>
							</div>
						</div>
					</div>
					<div class="objectives py-5 mt-5">
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-md-10">
									<div class="fs-20 mb-5 fw-bold cl-orange text-center">
										Việc đào tạo giúp cho các cán bộ được đào tạo không chỉ vận dụng kiến thức vào
										thực tế một cách hiệu quả mà còn xác định được lộ trình phát triển phù hợp với
										mục tiêu phát triển của Công ty. </div>
								</div>
							</div>
							<div class="row gx-0">
								<div class="col-md-4">
									<div class="traning_step">
										<div class="background"
											style="background-image: url(https://www.centralcons.vn/wp-content/uploads/2021/12/bg-step.jpg)">
										</div>
										<div class="inner">
											<div class="img">
												<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/step1.png"
													class="img-fluid" alt="">
											</div>
											<div class="num fs-30 fw-bold">01</div>
											<div class="text-justify">
												Hoạt động đào tạo vừa giúp CBNV đã được đào tạo áp dụng hiệu quả vào
												công việc thực tế, vừa giúp CBNV có thể xác định được lộ trình phát
												triển của bản thân phù hợp với mục tiêu phát triển của Công ty. </div>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="traning_step">
										...
										<div class="inner">
											<div class="img">
												<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/step2.png"
													class="img-fluid" alt="">
											</div>
											<div class="num fs-30 fw-bold">02</div>
											<div class="text-justify">
												CENTRAL xây dựng một hệ thống đánh giá công việc công tâm, khách quan
												nhằm tạo điều kiện tối đa cho việc nâng cao hiệu quả năng suất lao động
												và phát triển đối với các cá nhân được quy hoạch lên Quản lý cấp trung;
												Lãnh đạo kế thừa. Qua đó, nhằm tạo điều kiện để tất cả CBNV đều có cơ
												hội thăng tiến bình đẳng tại Công ty. </div>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="traning_step">
										...
										<div class="inner">
											<div class="img">
												<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/step3.png"
													class="img-fluid" alt="">
											</div>
											<div class="num fs-30 fw-bold">03</div>
											<div class="text-justify">
												Tất cả CBNV sau khi ký hợp đồng lao động có thời hạn với Công ty sẽ được
												tham dự các lớp đào tạo nghiệp vụ ngắn hạn, trung hạn theo kế hoạch đào
												tạo hàng năm hoặc đào tạo đột xuất theo yêu cầu cấp thiết của mỗi đơn
												vị. </div>
										</div>
									</div>
								</div>
							</div>
							<div class="text-center mt-3 mb-md-5">
								<a href="http://www.centralcons.vn/co-hoi-nghe-nghiep/" class="read_more">Tham gia với
									chúng tôi</a>
							</div>
						</div>
					</div>
...
var ajax_object = {"ajaxurl":"https:\/\/www.centralcons.vn\/wp-admin\/admin-ajax.php","link":"https:\/\/www.centralcons.vn\/phat-trien-nguon-nhan-luc\/"};
</script>
