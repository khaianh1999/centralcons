...
function apply_class_exclusion(e)
{
	...
	*/
			...
			<link rel="alternate" href="https://www.centralcons.vn/chinh-sach-nhan-su/" hreflang="vi" />
			<link rel="alternate" href="https://www.centralcons.vn/en/hr-policies/" hreflang="en" />
			<link rel="alternate"
				href="https://www.centralcons.vn/ch/%e4%ba%ba%e5%8a%9b%e8%b5%84%e6%ba%90%e6%94%bf%e7%ad%96/"
				hreflang="zh" />

			<!-- This site is optimized with the Yoast SEO plugin v22.1 - https://yoast.com/wordpress/plugins/seo/ -->
			<title>Chính sách nhân sự - CENTRAL</title>
			<link rel="canonical" href="https://www.centralcons.vn/chinh-sach-nhan-su/" />
			<meta property="og:locale" content="vi_VN" />
			<meta property="og:locale:alternate" content="en_US" />
			<meta property="og:locale:alternate" content="zh_CN" />
			<meta property="og:type" content="article" />
			<meta property="og:title" content="Chính sách nhân sự - CENTRAL" />
			<meta property="og:url" content="https://www.centralcons.vn/chinh-sach-nhan-su/" />
			<meta property="og:site_name" content="CENTRAL" />
			<meta property="article:modified_time" content="2021-12-01T05:08:00+00:00" />
			...
			<script type="application/ld+json"
				class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"https://www.centralcons.vn/chinh-sach-nhan-su/","url":"https://www.centralcons.vn/chinh-sach-nhan-su/","name":"Chính sách nhân sự - CENTRAL","isPartOf":{"@id":"https://www.centralcons.vn/#website"},"datePublished":"2021-11-21T14:02:55+00:00","dateModified":"2021-12-01T05:08:00+00:00","breadcrumb":{"@id":"https://www.centralcons.vn/chinh-sach-nhan-su/#breadcrumb"},"inLanguage":"vi","potentialAction":[{"@type":"ReadAction","target":["https://www.centralcons.vn/chinh-sach-nhan-su/"]}]},{"@type":"BreadcrumbList","@id":"https://www.centralcons.vn/chinh-sach-nhan-su/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.centralcons.vn/"},{"@type":"ListItem","position":2,"name":"Chính sách nhân sự"}]},{"@type":"WebSite","@id":"https://www.centralcons.vn/#website","url":"https://www.centralcons.vn/","name":"CENTRAL","description":"","potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.centralcons.vn/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"vi"}]}</script>
			<!-- / Yoast SEO plugin. -->
			...
			<link rel="alternate" title="JSON" type="application/json"
				href="https://www.centralcons.vn/wp-json/wp/v2/pages/384" />
			<link rel="EditURI" type="application/rsd+xml" title="RSD"
				href="https://www.centralcons.vn/xmlrpc.php?rsd" />
			<meta name="generator" content="WordPress 6.7.2" />
			<link rel='shortlink' href='https://www.centralcons.vn/?p=384' />
			<link rel="alternate" title="oNhúng (JSON)" type="application/json+oembed"
				href="https://www.centralcons.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.centralcons.vn%2Fchinh-sach-nhan-su%2F" />
			<link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"
				href="https://www.centralcons.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.centralcons.vn%2Fchinh-sach-nhan-su%2F&#038;format=xml" />
  ...
  gtag('config', 'UA-140682733-1');
		...
		<body
			class="page-template page-template-careers page-template-page-hr-policy page-template-careerspage-hr-policy-php page page-id-384 mega-menu-menu-1 unselectable">
			<!--[if lt IE 8]>
...
<![endif]-->
			...
			<div class="wrapper_content">
				<div class="page_cover">
					...
					<div class="meta_info">
						...
						<div class="breadcrumb_site"><span><span><a href="https://www.centralcons.vn/">Home</a></span> »
								<span class="breadcrumb_last" aria-current="page">Chính sách nhân sự</span></span></div>
					</div>
					<div class="stripe">
						<div class="container">
				...
				<div class="menu_careers">
					<div class="container">
						<ul id="menu-menu-careers" class="">
							...
							<li id="menu-item-390"
								class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-384 current_page_item menu-item-390">
								<a href="https://www.centralcons.vn/chinh-sach-nhan-su/" aria-current="page">Chính sách
									nhân sự</a></li>
							<li id="menu-item-389"
				...
				<div class="careers_page pt-5">
					<div class="container">
						<h1 class="fs-40 fw-bold">Chính sách nhân sự</h1>
						<hr>
						<div class="bg_blue mt-5">
							<div class="row gx-0 align-items-center">
								<div class="col-md-7">
									<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/hr1.jpg"
										class="img-fluid" alt="">
								</div>
								<div class="col-md-5">
												...
												<div class="wpb_column vc_column_container vc_col-sm-12">
													<div class="vc_column-inner">
														<div class="wpb_wrapper">
															<div
																class="wpb_text_column wpb_content_element hr_police_1 ">
																<div class="wpb_wrapper">
																	<p class="p1">Chính sách Nhân sự được xây dựng nhằm
																		mục đích đưa nguồn nhân lực trở thành một ưu thế
																		cạnh tranh. Được thể hiện đồng bộ từ chính sách
																		tuyển dụng, đào tạo – phát triển, lương – thưởng
																		– phúc lợi, các chế độ đãi ngộ, môi trường làm
																		việc và phát triển văn hóa doanh nghiệp để giữ
																		người giỏi, thu hút hiền tài, tạo điều kiện cho
																		CBNV được làm việc tốt nhất, được phát triển
																		nghề nghiệp và gắn bó lâu dài với Công ty.</p>
																</div>
															</div>
														</div>
													</div>
						...
						<div class="pt-5 mt-md-5 position-relative">
							<div class="row">
								<div class="col-md-7">
									<div class="content_gray">
										<div class="p-md-5 p-4 text-justify">
											<h3 class="fs-30 cl-orange fw-bold mb-4">Chính sách lương, thưởng, phúc lợi
												đãi ngộ</h3>
											<p>Tại CENTRAL, người lao động được hưởng các chế độ lương thưởng cạnh tranh
												theo quy chế rõ ràng. Thu nhập tùy thuộc vào trình độ, năng lực chuyên
												môn, vai trò, trách nhiệm, khối lượng công việc thực tế cũng như hiệu
												quả công việc mang lại.</p>
											<p>Bên cạnh việc đánh giá thi đua khen thưởng định kỳ. Công ty còn xây dựng
												và tổ chức thực hiện quy định khen thưởng của Công ty luôn đúng lúc kịp
												thời, có hiệu quả. Các tập thể, cá nhân đạt thành tích xuất sắc định kỳ
												hoặc đột xuất đều được công nhận và khen thưởng xứng đáng, công bằng,
												công khai.</p>
										</div>
									</div>
								</div>
							...
							<div class="img_abs">
								<img src="https://www.centralcons.vn/wp-content/uploads/2021/11/hr2.jpg"
									class="img-fluid" alt="">
							</div>
						</div>
					</div>
					<div class="pt-5 mt-5 corp_culture"
						style="background-image: url(https://www.centralcons.vn/wp-content/uploads/2021/11/hr3-scaled.jpg)">
						<div class="container">
							<div class="row justify-content-end gx-0">
								<div class="col-md-6">
									<div class="content_gray">
										<div class="p-md-5 p-4 text-justify">
											<h3 class="fs-30 cl-orange fw-bold mb-4">Văn hóa doanh nghiệp</h3>
											<p><strong>Đội ngũ chính trực là tài sản vô giá</strong>.</p>
											<p>CENTRAL là một đội ngũ trẻ khao khát chinh phục những thử thách và mục
												tiêu cao cả bằng những kế hoạch và sự chuẩn bị chu đáo minh bạch, nắm
												bắt và làm chủ khoa học kỹ thuật công nghệ, tạo dựng giá trị và mang đến
												những ý nghĩa tốt đẹp cho cuộc sống. Giá trị tốt nhất của cuộc sống là
												được làm việc và tận hiến nhiệt huyết, hãy chia sẻ mục tiêu phát triển
												tại CENTRAL.</p>
											<p>CENTRAL cam kết tạo ra một môi trường làm việc phát triển hài hòa với
												cộng đồng. Với môi trường làm việc chuyên nghiệp, năng động, sáng tạo và
												đoàn kết, CENTRAL tập trung phát triển tốt nhất cho các cá nhân, tạo ra
												cơ hội thăng tiến cho từng thành viên, mong muốn họ vươn lên cùng phát
												triển nghề nghiệp và gắn bó lâu dài, mang lại cuộc sống tốt đẹp hơn cả
												về giá trị vật chất lẫn tinh thần cho bản thân và gia đình.</p>
											<a href="http://www.centralcons.vn/co-hoi-nghe-nghiep/"
												class="read_more">Tham gia với chúng tôi</a>
										</div>
									</div>
								</div>
							</div>
...
var ajax_object = {"ajaxurl":"https:\/\/www.centralcons.vn\/wp-admin\/admin-ajax.php","link":"https:\/\/www.centralcons.vn\/chinh-sach-nhan-su\/"};
</script>
